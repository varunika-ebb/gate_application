  ...
  if (selectedSubject === 'CS') {
    return (
      <div className="syllabus-page">
        ...
        <section className="cs-syllabus-hero">
          <div className="container">
            <div className="hero-content">
              ...
              <p>Complete syllabus with 10 sections covering all CS topics</p>
            </div>
          </div>
        </section>
  ...
  if (selectedSubject === 'DA') {
    return (
      <div className="syllabus-page">
        ...
        <section className="da-syllabus-hero">
          <div className="container">
            <div className="hero-content">
              <button className="back-btn" onClick={handleBackToSubjects}>
                ← Back to Subjects
              ...
              <p>Complete syllabus with 7 sections covering all DA topics</p>
            </div>
          </div>
        </section>
  ...
  if (selectedSubject === 'GA') {
    return (
      <div className="syllabus-page">
        ...
        <section className="ga-syllabus-hero">
          <div className="container">
            <div className="hero-content">
              <button className="back-btn" onClick={handleBackToSubjects}>
                ← Back to Subjects
              ...
              <p>Complete syllabus with 4 sections covering all GA topics</p>
            </div>
          </div>
        </section>

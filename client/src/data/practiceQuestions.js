...
const practiceQuestions = {
  em: [
    // Engineering Mathematics - 30 questions covering all topics
    {
      ...
      marks: 1,
      topic: "Graph Theory",
      explanation: "In a complete graph, every vertex is connected to every other vertex. With n vertices, each vertex has (n-1) edges connecting to other vertices. However, this counts each edge twice (once from each endpoint), so the total number of edges is n(n-1)/2."
    },
    {
      id: 2,
      ...
      explanation: "The determinant of a 2×2 matrix [[a,b],[c,d]] is calculated as ad - bc. This is the standard formula for 2×2 matrix determinants, where you multiply the main diagonal elements and subtract the product of the off-diagonal elements."
    },
    {
      id: 3,
      ...
      marks: 2,
      topic: "Probability",
      explanation: "For independent events A and B, P(A ∩ B) = P(A) × P(B). Given P(A) = 0.3 and P(B) = 0.4, we have P(A ∩ B) = 0.3 × 0.4 = 0.12."
    },
    {
      id: 4,
      ...
      marks: 1,
      topic: "Calculus",
      explanation: "This is a fundamental limit in calculus. Using L'Hôpital's rule or the squeeze theorem, we can show that lim(x→0) (sin x)/x = 1. This is one of the most important limits in calculus."
    },
    {
      id: 5,
      ...
      marks: 1,
      topic: "Combinatorics",
      explanation: "In circular arrangements, we fix one person's position to avoid counting rotations as different arrangements. With 5 people, we arrange the remaining 4 people in 4! = 24 ways around the fixed person."
    },
    {
      id: 6,
